...
function defaultOperationRegistrySignature(ast, operationName) {
    return transforms_1.printWithReducedWhitespace(transforms_1.sortAST(transforms_1.hideStringAndNumericLiterals(transforms_1.dropUnusedDefinitions(ast, operationName))));
}
