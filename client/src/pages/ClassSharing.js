...
function ClassSharing() {
    ...
    var {
        data : dataM
    } = useQuery(GET_MATCHES_QUERY, {variables: {
            username
        }});
            ...
            <Container>
                <Grid stackable verticalAlign='top'>
                    <Grid.Row>
                        <Grid.Column width={5}>
                            <h2>My Schedule</h2>
                            <Button content="Add Class" icon="plus" labelPosition="left"
                                onClick={
                                    () => openModal("addClass")
                                }/> {/* {console.log(getClasses)} */}
                            {
                            getClasses.length > 0 ? <Table celled selectable striped unstackable>
                                <Table.Header>
                                    <Table.Row>
                                        <Table.HeaderCell width={8}
                                            textAlign="left">Class Code</Table.HeaderCell>
                                    </Table.Row>
                                </Table.Header>
                                {
                                getClasses && getClasses.map((classTemp) => (
                                    <Table.Row onClick={
                                        ...
                                        {/* <Table.Cell textAlign="center" >{(getClass({variables: {code: classTemp.code}}) && !console.log(classUsers)) ? classUsers.length : 7}</Table.Cell> */} </Table.Row>
                                ))
                            } </Table> : <Message info>
                                        ...
                                        <Card fluid
                                            ...
                                            <Card.Content>
                                                ...
                                                <Card.Meta>
                                                    <span className='date'>
                                                        {
                                                        matchTemp.score / 5 + ((matchTemp.score > 5) ? " shared classes" : " shared class")
                                                    }</span>
                                                </Card.Meta>
                                                {/* <Card.Description>
                ...
                <Modal.Content>
                    <Modal.Description> {
                        ...
                        <Form onSubmit={onSubmit}
                            ...
                            <Form.Input type="text" label="Course Code" name="code"
                                value={
                                    values.code
                                }
                                onChange={onChange}/>
                            <Button type="reset" color="grey"
                                onClick={
                                    () => closeModal("addClass")
                            }>
                                Cancel
